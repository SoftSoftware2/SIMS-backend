...
class StoreVehicleRequest extends FormRequest
{
    ...
    {
        return [
            'license' => 'required|string|max:15|unique:tenant.vehicles,license',
            'status' => 'required|string|in:available,using,stopped',
            'vehicle_type_id' => 'required|integer|exists:tenant.vehicle_types,id',
        ];
    }
